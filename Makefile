...
help:
	...
	@printf '%s\n' '  make run-ios        Run the latest iOS phone simulator build'
	@printf '%s\n' '  make run-ios-phone  Run the latest iOS phone simulator build'
	@printf '%s\n' '  make run-ios-ipad   Run the latest iOS iPad simulator build'
	@printf '%s\n' '  make run-macos      Run the latest macOS build'
