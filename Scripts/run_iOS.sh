...
if [ "$device_state" != "Booted" ]; then
  ...
  # Device Hub opens a device window when the simulator is started here.
  # Do not invoke it for an already running simulator: repeated run commands
  # must reuse the existing device window.
  open -a "Device Hub"
fi
